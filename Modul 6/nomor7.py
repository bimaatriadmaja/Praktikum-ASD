...
aw=detak();mergeSort(u_mrg);ak=detak();print("mergeSort : %g detik" %(ak-aw));
aw=detak();quickSort(u_qck);ak=detak();print("quickSort: %g detik" %(ak-aw));
aw=detak();mergeSortNew(u_mrgNew);ak=detak();print("mergeSort baru: %g detik" %(ak-aw));
aw=detak();quickSortNew(u_qckNew);ak=detak();print("quickSort baru: %g detik" %(ak-aw));
